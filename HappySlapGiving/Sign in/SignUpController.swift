...
class SignUpController: UIViewController ,GIDSignInUIDelegate{
    ...
    func configureViewComponents() {
        ...
        dividerView.anchor(top: signupButton.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 24, paddingLeft: 32, paddingBottom: 0, paddingRight: 32, width: 0, height: 50)
